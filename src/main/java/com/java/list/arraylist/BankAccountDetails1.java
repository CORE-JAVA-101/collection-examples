...
public class BankAccountDetails1 implements Comparable<BankAccountDetails1> {
	...
	/*
	 * public int compareTo(BankAccountDetails1 o) { // TODO Auto-generated
	 * method stub return this.bankName.compareTo(o.bankName);
	 * 
	 * }
	 */
	public int compareTo(BankAccountDetails1 o) {
		...
		// x is 0 when bank names same then it will sort by customer name, see
		// the output
		if (x == 0) {
