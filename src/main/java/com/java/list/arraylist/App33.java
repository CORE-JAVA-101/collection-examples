...
public class App33 {
	...
	public static void main(String[] args) {
		...
		Collections.sort(listForBankNameComparator, new BankNameComparator());// u hv to pass the comparator object wile sorting   
		...
		Collections.sort(listForBankNameCustomerNameComparator,
				new BankNameCustomerNameComparator());// sort by bank name, if bank name matches then sort by customer name
